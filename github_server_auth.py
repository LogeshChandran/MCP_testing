...
class ServerSettings(BaseSettings):
    ...
    github_client_id: str  = "Ov23liShuhqmtBwMHFaj" # Type: MCP_GITHUB_GITHUB_CLIENT_ID env var
    github_client_secret: str = "9ef35082265d0f14e6f85bf0b9741b0eeaab0f44"  # Type: MCP_GITHUB_GITHUB_CLIENT_SECRET env var
